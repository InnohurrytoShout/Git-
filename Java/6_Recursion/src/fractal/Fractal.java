...
public class Fractal {
	...
	private void drawKochCurve(Point2D p1, Point2D p2, int level) {
		...
		Turtle kochCurve = new Turtle (p1,p2);
		double distance = Point2D.distance(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 3;
		kochCurve.move(distance);
		Point2D p3 = new Point2D.Double(kochCurve.getPosition().getX(), kochCurve.getPosition().getY());
		kochCurve.turnLeft(60);
		kochCurve.move(distance);
		Point2D p4 = new Point2D.Double(kochCurve.getPosition().getX(), kochCurve.getPosition().getY());
		kochCurve.turnRight(120);
		kochCurve.move(distance);
		Point2D p5 = new Point2D.Double(kochCurve.getPosition().getX(), kochCurve.getPosition().getY());
		kochCurve.turnLeft(60);
		kochCurve.move(distance);
		level--;
	...
	private void drawTree(Point2D p1, Point2D p2, int level) {
		...
		tree.move( Point2D.distance(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 3);
		Point2D p3 = new Point2D.Double(tree.getPosition().getX(), tree.getPosition().getY());
		drawLine(p1, p3);
		tree.turnLeft(60);
		tree.move( Point2D.distance(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 3 * 2);
		Point2D p4 = new Point2D.Double(tree.getPosition().getX(), tree.getPosition().getY());
		tree.turnRight(180);
		tree.move( Point2D.distance(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 3 * 2);
		tree.turnLeft(105);
		tree.move( Point2D.distance(p1.getX(), p1.getY(), p2.getX(), p2.getY()) / 3 * 2);
		Point2D p5 = new Point2D.Double(tree.getPosition().getX(), tree.getPosition().getY());
		level --;
	...
	private void drawSierpinskiCarpet(Point2D p, double a, int level) {
		...
		Point2D p3 = new Point2D.Double( p.getX(), p.getY() + a / 3 * 2);
		drawSierpinskiCarpet(p3, a / 3, level);
		Point2D p4 = new Point2D.Double( p.getX() + a / 3, p.getY());
		drawSierpinskiCarpet(p4, a / 3, level);
		Point2D p5 = new Point2D.Double( p.getX() + a / 3 * 2, p.getY());
		drawSierpinskiCarpet(p5, a / 3, level);
		Point2D p6 = new Point2D.Double( p.getX() + a / 3 * 2, p.getY() + a / 3);
		drawSierpinskiCarpet(p6, a / 3, level);
		Point2D p7 = new Point2D.Double( p.getX() + a / 3 * 2, p.getY() + a / 3 * 2);
		drawSierpinskiCarpet(p7, a / 3, level);
		Point2D p8 = new Point2D.Double( p.getX() + a / 3, p.getY() + a / 3 * 2);
