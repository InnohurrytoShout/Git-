...
public class PublicInfixEvaluatorTest {
	...
	public void testEvaluatePlus() throws Exception {
		...
		assertEquals(new Integer(31), evaluator.evaluate("1 + ( 2 + ( 3 + ( 4 + 5 ) + 6 + ( 2 + 2 + 4 + 2 ) ) )"));
	}
	...
	public void testEvaluateSub() throws Exception {
		...
		assertEquals(new Integer(1), evaluator.evaluate("2 - 1"));
		
		assertEquals(new Integer(-10), evaluator.evaluate("2 - 10 + 8 - 10 * 5 / 5 - 5 + 5"));
	}
	...
	public void testEvaluateMixed() throws Exception {
		...
		assertEquals(new Integer(1), evaluator.evaluate("1 - ! 1 - 1"));
	}
